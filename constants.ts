...
export const ANALYSIS_RESULTS: Record<string, string> = {
  ...
  'nutrients.ME_kcal_per_kg': 'Metabolizable Energy (kcal/kg)',
  'nutrients.MECP_Ratio': 'ME/CP Ratio',
  'nutrients.Ca_pct': 'Calcium %',
  'nutrients.avP_pct': 'Available Phosphorus %',
  'nutrients.phytateP_pct': 'Phytate Phosphorus %',
  'nutrients.CaAvP_Ratio': 'Ca/AvP Ratio',
...
export const initialIngredients: Ingredient[] = [
    ...
    { id: 24, Name: 'Brewer\'s Yeast', category: 'Protein', description: 'Source of protein and B-vitamins', Inclusion_pct: 0, CP_pct: 45.0, ME_kcal_per_kg: 2600, Ca_pct: 0.1, avP_pct: 1.0, phytateP_pct: 0.1, Na_pct: 0.1, K_pct: 2.0, Cl_pct: 0.1, Lys_pct: 3.5, TSAA_pct: 1.2, Thr_pct: 2.5, Val_pct: 2.8, Ile_pct: 2.2, Leu_pct: 3.5, Arg_pct: 2.5, Try_pct: 0.5, Starch_pct: 5, CF_pct: 2.0, NDF_pct: 5.0, ADF_pct: 2.5, Ash_pct: 8.0, Choline_mg_per_kg: 4000, Price_USD_per_ton: 900 },
    // Enzymes
    {
      id: 25,
      Name: 'Phytase 5000',
      category: 'Enzymes',
      description: 'Phytase enzyme, 5000 FTU/g',
      ...
      Inclusion_pct: 0, CP_pct: 0, ME_kcal_per_kg: 0, Ca_pct: 0, avP_pct: 0, phytateP_pct: 0, Na_pct: 0, K_pct: 0, Cl_pct: 0, Lys_pct: 0, TSAA_pct: 0, Thr_pct: 0, Val_pct: 0, Ile_pct: 0, Leu_pct: 0, Arg_pct: 0, Try_pct: 0, Starch_pct: 0, CF_pct: 0, NDF_pct: 0, ADF_pct: 0, Ash_pct: 0, Choline_mg_per_kg: 0, Price_USD_per_ton: 4000
    },
    {
      id: 26,
      Name: 'NSP Enzyme',
      category: 'Enzymes',
      description: 'Xylanase and Beta-glucanase complex',
      standard_dosage_g_per_ton: 50,
      matrix: {
        'ME_kcal_per_kg': 80,
      },
      Inclusion_pct: 0, CP_pct: 0, ME_kcal_per_kg: 0, Ca_pct: 0, avP_pct: 0, phytateP_pct: 0, Na_pct: 0, K_pct: 0, Cl_pct: 0, Lys_pct: 0, TSAA_pct: 0, Thr_pct: 0, Val_pct: 0, Ile_pct: 0, Leu_pct: 0, Arg_pct: 0, Try_pct: 0, Starch_pct: 0, CF_pct: 0, NDF_pct: 0, ADF_pct: 0, Ash_pct: 0, Choline_mg_per_kg: 0, Price_USD_per_ton: 5000
    }
];

export const initialVitaminsData: Vitamin[] = [
  { id: 'vitA', name: 'Vitamin A', unit: 'IU', requiredInFeed: 10000, purity: 500000, processingLossPct: 10, storageLossPct: 5, pricePerKg: 25 },
  { id: 'vitD3', name: 'Vitamin D3', unit: 'IU', requiredInFeed: 3000, purity: 500000, processingLossPct: 10, storageLossPct: 5, pricePerKg: 30 },
  { id: 'vitE', name: 'Vitamin E', unit: 'IU', requiredInFeed: 40, purity: 500, processingLossPct: 15, storageLossPct: 10, pricePerKg: 45 },
  { id: 'vitK3', name: 'Vitamin K3 (MSB)', unit: 'mg', requiredInFeed: 3, purity: 515, processingLossPct: 10, storageLossPct: 5, pricePerKg: 35 },
  { id: 'vitB1', name: 'Vitamin B1 (Thiamin)', unit: 'mg', requiredInFeed: 2.5, purity: 980, processingLossPct: 5, storageLossPct: 2, pricePerKg: 50 },
  { id: 'vitB2', name: 'Vitamin B2 (Riboflavin)', unit: 'mg', requiredInFeed: 7, purity: 800, processingLossPct: 5, storageLossPct: 2, pricePerKg: 40 },
  { id: 'vitB6', name: 'Vitamin B6 (Pyridoxine)', unit: 'mg', requiredInFeed: 4, purity: 980, processingLossPct: 5, storageLossPct: 2, pricePerKg: 55 },
  { id: 'vitB12', name: 'Vitamin B12 (Cobalamin)', unit: 'mg', requiredInFeed: 0.02, purity: 10, processingLossPct: 10, storageLossPct: 5, pricePerKg: 150 },
  { id: 'niacin', name: 'Niacin (B3)', unit: 'mg', requiredInFeed: 40, purity: 990, processingLossPct: 5, storageLossPct: 2, pricePerKg: 20 },
  { id: 'pantothenic', name: 'Pantothenic Acid (B5)', unit: 'mg', requiredInFeed: 12, purity: 900, processingLossPct: 5, storageLossPct: 2, pricePerKg: 30 },
  { id: 'folic', name: 'Folic Acid (B9)', unit: 'mg', requiredInFeed: 1.5, purity: 950, processingLossPct: 10, storageLossPct: 5, pricePerKg: 60 },
  { id: 'biotin', name: 'Biotin (B7)', unit: 'mg', requiredInFeed: 0.2, purity: 20, processingLossPct: 10, storageLossPct: 5, pricePerKg: 200 },
];

export const initialMineralsData: Mineral[] = [
  { id: 'mn', name: 'Manganese (Mn)', requiredInFeed_mg_per_kg: 100, selectedSourceIndex: 0, sources: [{ name: 'Manganese Sulfate', productConcentration_pct: 32, pricePerKg: 1.5 }] },
  { id: 'zn', name: 'Zinc (Zn)', requiredInFeed_mg_per_kg: 90, selectedSourceIndex: 0, sources: [{ name: 'Zinc Sulfate', productConcentration_pct: 35, pricePerKg: 1.8 }, { name: 'Zinc Oxide', productConcentration_pct: 72, pricePerKg: 2.5 }] },
  { id: 'fe', name: 'Iron (Fe)', requiredInFeed_mg_per_kg: 40, selectedSourceIndex: 0, sources: [{ name: 'Ferrous Sulfate', productConcentration_pct: 20, pricePerKg: 0.8 }] },
  { id: 'cu', name: 'Copper (Cu)', requiredInFeed_mg_per_kg: 10, selectedSourceIndex: 0, sources: [{ name: 'Copper Sulfate', productConcentration_pct: 25, pricePerKg: 2.0 }] },
  { id: 'i', name: 'Iodine (I)', requiredInFeed_mg_per_kg: 1, selectedSourceIndex: 0, sources: [{ name: 'Calcium Iodate', productConcentration_pct: 62, pricePerKg: 40 }] },
  { id: 'se', name: 'Selenium (Se)', requiredInFeed_mg_per_kg: 0.2, selectedSourceIndex: 0, sources: [{ name: 'Sodium Selenite', productConcentration_pct: 45, pricePerKg: 120 }] },
];